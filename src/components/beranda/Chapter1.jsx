  ...
  return (
    <section className="relative flex flex-col items-center w-full text-[#013047]">
      <div data-aos="fade-up">
        <h1 className="text-[6vw] sm:text-[5vw] md:text-[4.5vw] lg:text-[4vw] text-center font-storybook mt-[8vw]">
          {content.title1}
        </h1>
        <p className="text-[4.5vw] sm:text-[3.8vw] md:text-[3.2vw] lg:text-[3vw] text-center font-storybook">
          {content.subTitle1}
        </p>
        <p className="text-[3.2vw] sm:text-[2.5vw] md:text-[2vw] lg:text-[1.5vw] text-justify mx-[10vw] mt-[1vw] font-primeform-medium leading-relaxed">
          {content.content1}
        </p>
      </div>
      ...
      >
        ...
        <p className="w-[80vw] text-[3.2vw] sm:text-[2.5vw] md:text-[2vw] lg:text-[1.5vw] p-3 text-[#ECC691] text-justify ml-[2vw] mt-[3vw] lg:mt-[0] lg:text-left lg:w-[50vw] lg:mx-[2vw] leading-relaxed">
