  ...
  return (
    <div className="flex flex-col justify-center w-full min-h-screen gap-[3vw]">
      ...
      >
        {renderColumn([
          {
            src: "/images/dokumentasi/day1/1.webp",
            width: "40vw",
            height: "50vw",
          },
          {
            src: "/images/dokumentasi/day1/2.webp",
            width: "40vw",
            height: "30vw",
          },
          {
          ...
          {
            src: "/images/dokumentasi/day1/6.webp",
            width: "40vw",
            height: "30vw",
          },
          {
            src: "/images/dokumentasi/day1/7.webp",
            width: "40vw",
            height: "50vw",
          },
          {
            src: "/images/dokumentasi/day1/8.webp",
            width: "40vw",
            height: "30vw",
          },
        ])}
        {renderColumn([
          {
            src: "/images/dokumentasi/day1/9.webp",
            width: "40vw",
            height: "30vw",
          },
          {
            src: "/images/dokumentasi/day1/10.webp",
            width: "40vw",
            height: "50vw",
          },
          {
            src: "/images/dokumentasi/day1/11.webp",
            width: "40vw",
            height: "30vw",
          },
          {
            src: "/images/dokumentasi/day1/12.webp",
            width: "40vw",
            height: "50vw",
          },
          {
            src: "/images/dokumentasi/day1/13.webp",
            width: "40vw",
            height: "30vw",
          },
          {
            src: "/images/dokumentasi/day1/14.webp",
            width: "40vw",
            height: "50vw",
          },
          {
            src: "/images/dokumentasi/day1/15.webp",
            width: "40vw",
            height: "30vw",
          },
          {
            src: "/images/dokumentasi/day1/16.webp",
            width: "40vw",
            height: "50vw",
          },
        ])}
